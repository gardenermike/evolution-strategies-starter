...
wget --quiet http://download.redis.io/releases/redis-4.0.9.tar.gz -O redis-4.0.9.tar.gz
...
sudo /opt/conda/bin/conda install python=3.6
...
# Tensorflow 0.11.0
sudo /opt/conda/bin/conda install -c conda-forge -y tensorflow=1.8.0
...
sudo /opt/conda/bin/pip install \
    ...
    six==1.10.0 \
    awscli
sudo /opt/conda/bin/pip install gym-retro baselines

# TODO: need to install contest
